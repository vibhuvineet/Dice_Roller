...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // An image appears without rolling the dice when the app starts
        rollDice()
    }
    ...
    private fun rollDice() {
        // Create first Dice object with 6 sides and roll the dice
        val firstDice = Dice(6)
        val diceRoll = firstDice.roll()
        // Create second dice object with 6 sides in the same screen
        val secondDice = Dice(6)
        val diceRoll2 = secondDice.roll()
        // Find the first ImageView in the layout
